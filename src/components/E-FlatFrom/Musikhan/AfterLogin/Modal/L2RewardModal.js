...
const L2RewardModal = (props) => {
  ...
  const selectRewardTokenListToPage = async (rewardTokenList) => {
    ...
    await axios.post("http://localhost:4000/block/l2RewardResult", { rewardTimeOfLastUpdate, rewardTokenAmount });
        ...
        <section>
          ...
          <div className="rewardL2-ModalTokenInfoContainer">
            <div className="rewardL2-ModalTokensSearchInputSection">
              <FaSearchIcon className="rewardL2-ModalSearchIcon" />
              <input
