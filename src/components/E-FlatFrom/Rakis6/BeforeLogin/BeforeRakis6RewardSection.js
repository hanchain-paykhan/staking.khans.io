...
import "../AfterLogin/Rakis6RewardSection.scss";
...
const BeforeRakis6RewardSection = () => {
  ...
  const { rakis6UnClaimedRewardToEth, rakis6TotalRewardReceivedToEth, rakis6TotalRewardAmount } = useSelector(
    (state) => state.rakis6AirDropReward
  );
      ...
      <>
        ...
        <div className="rakis6-AirDrop-Reward-EstSection">
          <p>
            ...
            <FiRefreshCcwIcon className="rakis6-AirDrop-Reward-RefreshIcon" />
            HAN
          </p>
        </div>
