...
import { FiRefreshCcwIcon, MdHelpIcon } from "../../../Icons/reactIcons";
  ...
  return (
    <div>
      ...
      <div className="allRewardsSprCumulativeSection">
        <p>
          Estimated Interest : {oldSprResultValue} <FiRefreshCcwIcon className="allRefreshSprClaimIcon" onClick={changeSprState} /> HAN{" "}
        </p>
      </div>
