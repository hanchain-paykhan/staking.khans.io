...
export const SheepooriTokenContract = new web3.eth.Contract(
  SheepooriTokenABI.abi,
...
export const SheepooriStakingContract = new web3.eth.Contract(
  SheepooriStakingABI.abi,
...
export const testTokenContract = new web3.eth.Contract(
  testTokenABI.abi,
  testTokenAddress
);
...
export const testStakingContract = new web3.eth.Contract(
  testStakingABI.abi,
  testStakingAddress
);
