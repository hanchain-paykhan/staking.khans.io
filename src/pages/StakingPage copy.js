...
import { FcCancelIcon, FiRefreshCcwIcon, MdHelpIcon } from "../components/Icons/reactIcons";
...
const StakingPage = () => {
  ...
  const { getAmount, stakingTokenBalance, canAmountStake, successApprove, HanQuantityLpQuantityPerYear1HanValue, allowanceAmount } =
